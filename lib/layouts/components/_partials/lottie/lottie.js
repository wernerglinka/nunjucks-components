...
// Self-hosted copy of @lottiefiles/lottie-player, placed in the build by
// metalsmith.js from node_modules; the version is managed in package.json
const PLAYER_SRC = '/assets/vendor/lottie-player.js';
